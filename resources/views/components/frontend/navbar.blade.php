            ...
            <div class="flex flex-stretch items-center">
                ...
                <div class="w-auto">
                    <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"id="menu">
                        <li class="mx-3 py-6 md:py-0">
                            <a href="{{ route('index') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Showcase</a>
                        </li>
                        @auth
                            <li class="mx-3 py-6 md:py-0">
                ...
                <div class="w-auto">
                    <ul class="items-center flex">
                        ...
                        <li class="ml-6">
                            <a id="header-cart" href="{{ route('cart') }}" class="flex items-center justify-center w-8 h-8 text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}">
